...
class send_invoice:
    @staticmethod
    def run(instance, company_name, email_address, country, product, quantity, unit_price, email_body, discount_percent=0, address_line_1='', city='', tax_number=''):
        ...
        payload = {
            ...
            "Thread ID": lambda_function.response['thread_id']
        }
